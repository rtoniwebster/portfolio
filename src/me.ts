  ...
  experience: [
    {
      ...
      bullets: [
        "Lead the design and development of custom web and mobile applications for clients in industries including healthcare, real estate, and e-commerce.",
        "Specialize in full-stack development using React, React Native, Node.js and Firebase.",
        "Integrated Al-powered features such as chatbots, predictive search,and image recognition using OpenAl and TensorFlow APls. Delivered intuitive, high-performance apps deployed to iOS, Android, and the web'",
        "Known for clean code, responsive Uls, and scalable architecture.",
      ],
    },
    {
      ...
      bullets: [
        "Supported the development of Al-enhanced web tools for internal and client-facing platforms.",
        "Built and maintained front-end components in React and Vue, while contributing to backend APls using Python(FastAPl) and PostgreSQL",
        "Assisted in implementing machine learning models for lead scoring, sentiment analysis, and document processing.",
        "Collaborated in Agile team, participated in sprint planning, and maintained a strong focus on performance, accessibility, and clean documentation.",
      ],
    },
  ],
  projects: [
